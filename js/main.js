...
const portfolioProjects = [
    ...
    },
    {
        ...
        screenshots: ['./images/pos_retail_mockup.jpg', './images/pos_retail_drawer.jpg'],
        icon: 'shopping-bag',
        ...
        fullDesc: 'An enterprise Point of Sale (POS) solution engineered to solve retail businesses\' requirement for completely autonomous, zero-dependency offline checkout operations. Supports multi-payment options (QRIS, Cash, Split Bill), ESC/POS hardware integration, and inventory management.',
            ...
            <div class="p-5 flex-1 flex flex-col">
                ...
                <div class="pt-3 border-t border-base flex items-center justify-between text-xs mt-auto">
                    ...
                    <div class="flex items-center gap-2 text-muted">
                        ...
                        ` : ''}
                        ${p.links?.github ? `
                            <a href="${p.links.github}" target="_blank" rel="noopener noreferrer" class="hover:text-heading" title="GitHub Repository">
